...
Group: Documentation
Packager: Asher256
Source: https://www.asher256.com/projects/jargoninformatique/%{name}-%{version}.tar.gz
BuildRoot: %{_tmppath}/%{name}-buildroot
URL: https://www.asher256.com/projects/jargoninformatique/
...
* Wed Aug 24 2005 Asher256 1.3.4-1
