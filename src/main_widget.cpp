...
chier LISEZ-MOI.htm et COPYING.txt pour plus d\'informations.  ");
    ...
    { Fl_Box* o = label_email = new Fl_Box(10, 86, 235, 15, "Email:  http://www.asher256.com/contact");
      o->labelfont(5);
      o->labelsize(12);
      o->labelcolor((Fl_Color)206);
      o->align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE);
    }
    { Fl_Box* o = label_url = new Fl_Box(11, 106, 235, 15, "Url:    https://www.asher256.com/projects/jargoninformatique/");
      o->labelfont(5);
      o->labelsize(12);
